...
```{r scatterPlot, fig.cap="Scatterplot showing reanalysis p-values as a function of original p-values, classified by reproducibility outcome. Axes are on a log scale. Dashed lines represent the typical 0.05 threshold for statistical significance. For display purposes, 41 values below 0.001 are not shown. Original values reported as thresholds (e.g., p < .05) are represented by the threshold value when there was a major discrepancy and represented by the reanalysis value when there was a match.", fig.path="figs/"}
