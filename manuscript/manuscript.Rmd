...
```{r scatterPlot, fig.cap="Scatterplot showing reanalysis p-values as a function of reported p-values, classified by reproducibility outcome. Axes are on a log scale. For display purposes, 41 values below 0.001 are not shown.", fig.path="figs/"}
